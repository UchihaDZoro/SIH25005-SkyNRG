...
KP_NAMES = ["shoulder_1","2","3","abdomen_width_1","shoulder_2","6","spine_bw_hips","abdomen_width_2"]
...
class DashboardTop:
    def __init__(self, root, image_path, model_path=None):
        ...
        self.img_bgr = cv2.resize(self.img_bgr, (640, 640), interpolation=cv2.INTER_LINEAR)
