...
# ---- top-view keypoint names (12) ----
KP_NAMES = [
    "wither", "shoulder_2", "spine", "shoulder_1", "abdomen_width_2",
    "hip_bone_2", "abdomen_width_1", "pin_bone_2", "hip_bone_1",
    "pin_bone_1", "tail_bone", "spine_bw_hips"
]
...
class DashboardTop:
    def __init__(self, root, image_path, model_path=None):
        ...
        self.img_bgr = cv2.resize(self.img_bgr, (640, 480), interpolation=cv2.INTER_LINEAR)
